...
const navigationItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { icon: FileText, label: "Attributes", href: "/admin/attributes" },
      { icon: AlertTriangle, label: "Pending Review", href: "/admin/products/pending", badge: 5 },
    ],
  },
  {
    icon: Store,
    ...
    children: [
      ...
      { icon: AlertTriangle, label: "Pending Approval", href: "/admin/vendors/pending", badge: 3 },
      { icon: CreditCard, label: "Payouts", href: "/admin/vendors/payouts" },
      { icon: TrendingUp, label: "Commissions", href: "/admin/vendors/commissions" },
    ],
  },
  {
    icon: Users,
  ...
  },
  {
    ...
    children: [
      ...
      { icon: Tag, label: "Flash Deals", href: "/admin/flash-deals" },
    ],
  },
  {
    icon: Ticket,
    label: "Support",
    children: [
      { icon: Ticket, label: "Tickets", href: "/admin/tickets", badge: 8, badgeColor: "bg-orange-500" },
      { icon: MessageSquare, label: "Disputes", href: "/admin/disputes", badge: 2, badgeColor: "bg-red-500" },
  ...
  },
  {
    ...
    label: "Shipping",
    children: [
      { icon: Truck, label: "Zones", href: "/admin/shipping/zones" },
      { icon: DollarSign, label: "Rates", href: "/admin/shipping/rates" },
    ],
  },
  {
    icon: BarChart3,
    label: "Reports",
    children: [
      { icon: TrendingUp, label: "Sales Report", href: "/admin/reports/sales" },
      { icon: Package, label: "Product Report", href: "/admin/reports/products" },
      { icon: Users, label: "Customer Report", href: "/admin/reports/customers" },
      { icon: Store, label: "Vendor Report", href: "/admin/reports/vendors" },
    ],
  },
  {
    icon: Settings,
    ...
    children: [
      ...
      { icon: Shield, label: "Roles & Permissions", href: "/admin/settings/roles" },
      { icon: FileText, label: "Audit Logs", href: "/admin/settings/audit-logs" },
    ],
  },
];
